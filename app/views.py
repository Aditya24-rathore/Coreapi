...
# # # #             serializer.save()
# # # #             return JsonResponse({'msg':'datacreated'})
...
# # # #             if serializer.is_valid():
# # # #                 serializer.save()
# # # #                 return JsonResponse({'msg':'object_updated','new_data':serializer.data})
# # # #             else:
...
# # # #             stream=io.BytesIO(data)
# # # #             new_p_data=JSONParser().parse(stream)
# # # #             serializer=StudentSerializer(old_data,data=new_p_data,partial=True)
# # # #             if serializer.is_valid():
# # # #                 serializer.save()
# # # #                 return JsonResponse({'msg':'object_updated','new_data':serializer.data})
# # # #             else:
